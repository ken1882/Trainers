...
ASSET_HOST = 'https://assets-ak.mist-train-girls.com/production-client-web-assets'
STATIC_HOST = 'https://assets-ak.mist-train-girls.com/production-client-web-static'
