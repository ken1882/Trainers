...
Enum = {
  'Crashed': {
    'pos': ((125, 128),(138, 293),(149, 458),(463, 472),(479, 93),(875, 95),(801, 297),(820, 468),(487, 260),),
    'color': ((32, 35, 58),(32, 35, 58),(32, 35, 58),(32, 35, 58),(32, 35, 58),(32, 35, 58),(32, 35, 58),(32, 35, 58),(32, 34, 57),)
  },
  'StageSelect': {
  ...
  'RematchEnd4': {
    'pos': ((188, 70),(202, 498),(287, 483),(560, 502),(700, 480),(778, 478),),
    'color': ((74, 109, 173),(153, 156, 156),(165, 162, 173),(188, 161, 221),(57, 103, 165),(82, 138, 206),)
  },
  'HomePage': {
    'pos': ((147, 369),(943, 330),(26, 186),(312, 492),(874, 515),),
    'color': ((113, 137, 219),(20, 32, 53),(251, 255, 255),(255, 255, 255),(189, 138, 69),)
  },
  'HomePage2': {
  ...
  'HomePage4': {
    'pos': ((169, 372),(83, 26),(936, 325),(797, 25),(648, 29),),
    'color': ((113, 137, 219),(70, 127, 156),(24, 31, 48),(170, 227, 227),(69, 48, 42),)
  },
  'HomePage5': {
    'pos': ((148, 374),(960, 372),(32, 514),(84, 94),),
    'color': ((113, 137, 219),(156, 254, 253),(255, 255, 255),(72, 118, 182),)
  },
  'VsSpiritSelect': {
  ...
  'Errand6': {
    'pos': ((11, 28),(26, 499),(53, 31),(469, 27),(197, 191),),
    'color': ((154, 187, 240),(243, 243, 231),(66, 101, 121),(121, 196, 219),(245, 234, 201),)
  },
  'BSHome': {
  ...
  'DateChanged': {
    'pos': ((204, 150),(332, 164),(363, 164),(441, 396),(729, 387),(764, 158),),
    'color': ((238, 238, 238),(215, 161, 72),(138, 154, 154),(121, 122, 150),(238, 238, 238),(238, 238, 238),)
  },
  'SkillTrainFinished': {
    'pos': ((142, 26),(74, 555),(207, 161),(957, 502),(791, 555),),
    'color': ((108, 105, 105),(15, 19, 23),(238, 238, 238),(42, 30, 19),(16, 16, 20),)
  },
  'DojoMain': {
    'pos': ((16, 26),(62, 558),(467, 26),(956, 501),),
    'color': ((146, 178, 232),(40, 52, 60),(121, 197, 219),(81, 56, 36),)
  },
  'DojoUnitSelect': {
    'pos': ((13, 23),(226, 28),(469, 29),(700, 510),(911, 507),),
    'color': ((166, 202, 251),(212, 209, 209),(121, 190, 215),(161, 173, 174),(165, 91, 52),)
  },
  'Disconnected': {
  ...
  'Disconnected2': {
    'pos': ((211, 168),(723, 170),(313, 402),(434, 399),(530, 401),(655, 401),),
    'color': ((238, 238, 238),(238, 238, 238),(121, 122, 150),(121, 122, 150),(255, 164, 90),(243, 137, 85),)
  },
  'Shop': {
    'pos': ((909, 531),(778, 553),(466, 28),(787, 33),(10, 24),(941, 485),(690, 114),),
    'color': ((138, 136, 158),(157, 153, 174),(121, 194, 219),(30, 128, 127),(168, 205, 253),(135, 143, 160),(255, 255, 223),)
  },
  'Shop2': {
    'pos': ((9, 26),(483, 23),(788, 32),(57, 494),(954, 528),),
    'color': ((165, 201, 251),(121, 191, 215),(48, 130, 138),(255, 204, 100),(125, 117, 140),)
  }
}
...
def is_stucked():
  global StageArriveTime
  return StageDepth and datetime.now() > StageArriveTime + timedelta(minutes=5)
