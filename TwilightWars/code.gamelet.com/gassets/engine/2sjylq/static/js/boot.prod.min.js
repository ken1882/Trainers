...
function (e, t, n) {
    var r, o, i = e.CgLibs = e.CgLibs || {},
        ...
        l = !0,
        c = !1,
        f = atob("L3JlY29yZC9wbGF5Lw=="),
        d = atob("c3R1bjpzdHVuLmwuZ29vZ2xlLmNvbToxOTMwMg==");
    var p = function () {
        for (var e = "a".charCodeAt(0), t = "A".charCodeAt(0), n = "0123456789", r = 0; r < 26; ++r) n += String.fromCharCode(e + r, t + r);
        return n
    }();
    var h = function (e) {
        for (var t = "", n = p.len; t.length < e;) t += p.charAt(Math.floor(Math.random() * n));
        return t
    }(16);
    ...
    a.push(function (e) {
        o = e.projectCode, e.homeUrl.replace(/\/$/, ""), r = e.svrUrl.replace(/\/$/, ""), l = "prod" == e.env, c = 1 == e.svr_recorder, l && (_ = Date.now() + 30, v(60).then(S))
    });
    ...
    e.addEventListener("pointermove", w, !0), e.addEventListener("pointerdown", w, !0), e.addEventListener("keydown", w, !0);
    var x = null,
        _ = 0,
        C = [],
        S = function () {
            _ = _ || Date.now();
            var r, i = u(o + "AToken") || "";
            (r = i, r ? x && x.token == r ? Promise.resolve(x.user) : new Promise(e => {
                ...
                return function (e) {
                    ...
                    return k ? (r = T(k.contentWindow), Promise.resolve(r)) : new Promise(function (e) {
                        var r = "iframe" + h,
                            o = n(`<iframe id="${r}" sandbox="allow-same-origin" style="display: none"></iframe>`);
                        o.appendTo("body"), o.ready(function () {
                            k = t.getElementById(r), e(T(k.contentWindow))
                        })
                    })
                }(e).then(function (e) {
                    return function (e) {
                        ...
                        return o.onicecandidate = function (e) {
                            ...
                            }), k && (n(k).remove(), k = null), i ? Object.keys(t) : L(t)
                        })
                    }(e)
                }).then(function (e) {
                    return e.length && ((E = {
                ...
                if (n) {
                    var l = s.platform;
                    e.device && e.device.platform && (l = e.device.platform), n.platform = l;
                    var d = m(n);
                    u("gltmsrec", d), i = r && i || "";
                    var p = {
                        duration: 0,
                    ...
                    if (!t.hidden && (b > _ || c) && (p.duration = Math.ceil((Date.now() - _) / 1e3)), C.includes(i) || (C.push(i), p.plays = 1), _ = Date.now(), p.duration || p.plays) {
                        var h = m(p);
                        y(f + o, {
                            token: i,
                            record: d,
