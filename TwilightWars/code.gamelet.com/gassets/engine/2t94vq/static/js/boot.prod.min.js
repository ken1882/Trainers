...
! function (e, t) {
    ...
    x.fn = x.prototype = {
        ...
        for ("boolean" == typeof a && (l = a, a = arguments[s] || {}, s++), "object" == typeof a || h(a) || (a = {}), s === u && (a = this, s--); s < u; s++)
            if (null != (e = arguments[s]))
                for (t in e) r = e[t], "__proto__" !== t && a !== r && (l && r && (x.isPlainObject(r) || (o = Array.isArray(r))) ? (n = a[t], i = o && !Array.isArray(n) ? [] : o || x.isPlainObject(n) ? n : {}, o = !1, a[t] = x.extend(l, i, r)) : void 0 !== r && (a[t] = r));
        return a
    }, x.extend({
    ...
    var C = function (e) {
        var t, n, r, o, i, a, s, u, l, c, f, d, p, h, g, m, v, y, b, w = "sizzle" + 1 * new Date,
            x = e.document,
            _ = 0,
            C = 0,
            S = ue(),
        ...
        try {
            P.apply(O = D.call(x.childNodes), x.childNodes), O[x.childNodes.length].nodeType
        } catch (t) {
            P = {
        ...
        function se(e, t, r, o) {
            ...
            if (!o && (d(t), t = t || p, g)) {
                if (11 !== x && (f = Q.exec(e)))
                    ...
                    if (v = e, y = t, 1 === x && (z.test(e) || W.test(e))) {
                        for ((y = ee.test(e) && ve(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(re, oe) : t.setAttribute("id", c = w)), s = (h = a(e)).length; s--;) h[s] = (c ? "#" + c : ":scope") + " " + be(h[s]);
                        v = h.join(",")
                    }
                    try {
        ...
        for (t in n = se.support = {}, i = se.isXML = function (e) {
                ...
                return a != p && 9 === a.nodeType && a.documentElement && (h = (p = a).documentElement, g = !i(p), x != p && (o = p.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", ie, !1) : o.attachEvent && o.attachEvent("onunload", ie)), n.scope = ce(function (e) {
                ...
                filter: {
                    ...
                    ATTR: function (e, t, n) {
                        return function (r) {
                            var o = se.attr(r, e);
                            return null == o ? "!=" === t : !t || (o += "", "=" === t ? o === n : "!=" === t ? o !== n : "^=" === t ? n && 0 === o.indexOf(n) : "*=" === t ? n && -1 < o.indexOf(n) : "$=" === t ? n && o.slice(-n.length) === n : "~=" === t ? -1 < (" " + o.replace(H, " ") + " ").indexOf(n) : "|=" === t && (o === n || o.slice(0, n.length + 1) === n + "-"))
                        }
                    },
                    ...
                    PSEUDO: function (e, t) {
                        ...
                        return o[w] ? o(t) : 1 < o.length ? (n = [e, e, "", t], r.setFilters.hasOwnProperty(e.toLowerCase()) ? le(function (e, n) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || a)
                            if (c = (f = t[w] || (t[w] = {}))[t.uniqueID] || (f[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[r] || t;
                                ...
                                if ((l = c[i]) && l[0] === _ && l[1] === s) return d[2] = l[2];
            ...
            return r && !r[w] && (r = Ce(r)), o && !o[w] && (o = Ce(o, i)), le(function (i, a, s, u) {
                ...
                if (i) {
                    if (o || e) {
                        ...
                        for (c = v.length; c--;)(f = v[c]) && -1 < (l = o ? R(i, f) : d[c]) && (i[l] = !(a[l] = f))
                    }
                } else v = _e(v === a ? v.splice(h, v.length) : v), o ? o(null, a, v, u) : P.apply(a, v)
            })
        }
        ...
        return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function (e, t) {
            ...
            for (s = e, u = [], l = r.preFilter; s;) {
                for (a in n && !(o = B.exec(s)) || (o && (s = s.slice(o[0].length) || s), u.push(i = [])), n = !1, (o = W.exec(s)) && (n = o.shift(), i.push({
                        value: n,
                        type: o[0].replace($, " ")
            ...
            var n, o, i, s, u, c, f = [],
                ...
                m = k[e + " "];
            if (!m) {
                for (t || (t = a(e)), n = t.length; n--;)(m = Se(t[n]))[w] ? f.push(m) : h.push(m);
                (m = k(e, (o = h, s = 0 < (i = f).length, u = 0 < o.length, c = function (e, t, n, a, c) {
                    ...
                    if (v += y, s && y !== v) {
                        ...
                        if (e) {
                            if (0 < v)
                                for (; y--;) b[y] || w[y] || (w[y] = j.call(a));
                            w = _e(w)
                        }
                        P.apply(a, w), c && !e && 0 < w.length && 1 < v + i.length && se.uniqueSort(a)
                    }
                    return c && (_ = S, l = x), b
                }, s ? le(c) : c))).selector = e
            }
            ...
            if (n = n || [], 1 === p.length) {
                ...
                for (i = J.needsContext.test(e) ? 0 : u.length; i-- && (l = u[i], !r.relative[c = l.type]);)
        ...
        }, n.sortStable = w.split("").sort(A).join("") === w, n.detectDuplicates = !!f, d(), n.sortDetached = ce(function (e) {
    ...
    (x.fn.init = function (e, t, n) {
        ...
        if (n = n || O, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : m, !0)), A.test(r[1]) && x.isPlainObject(t))
    ...
    x.fn.extend({
        ...
        x.fn[e] = function (n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = x.filter(r, o)), 1 < this.length && (P[e] || x.uniqueSort(o), M.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var R = /[^\x20\t\r\n\f]+/g;
    ...
    x.Callbacks = function (e) {
        var t, n;
        e = "string" == typeof e ? (t = e, n = {}, x.each(t.match(R) || [], function (e, t) {
            n[t] = !0
        }), n) : x.extend({}, e);
        var r, o, i, a, s = [],
            u = [],
                ...
                o = {
                    ...
                    then: function (t, r, o) {
                                ...
                                var s = this,
                                    ...
                                    l = function () {
                                        ...
                                        if (!(t < i)) {
                                            ...
                                            l = e && ("object" == typeof e || "function" == typeof e) && e.then, h(l) ? o ? l.call(e, a(i, n, N, o), a(i, n, I, o)) : (i++, l.call(e, a(i, n, N, o), a(i, n, I, o), a(i, n, N, n.notifyWith))) : (r !== N && (s = void 0, u = [e]), (o || n.resolveWith)(s, u))
                                        }
                                    },
                                    c = o ? l : function () {
                                        try {
                                            ...
                                            x.Deferred.exceptionHook && x.Deferred.exceptionHook(e, c.stackTrace), i <= t + 1 && (r !== I && (s = void 0, u = [e]), n.rejectWith(s, u))
                                        }
                                    };
                        ...
                        return x.Deferred(function (e) {
                            n[0][3].add(a(0, e, h(o) ? o : N, e.notifyWith)), n[1][3].add(a(0, e, h(t) ? t : N)), n[2][3].add(a(0, e, h(r) ? r : I))
                        }).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            if (t <= 1 && (q(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || h(i[n] && i[n].then))) return a.then();
    ...
    }), x.ready.then = U.then, "complete" === m.readyState || "loading" !== m.readyState && !m.documentElement.doScroll ? e.setTimeout(x.ready) : (m.addEventListener("DOMContentLoaded", H), e.addEventListener("load", H));
    ...
    x.extend({
        ...
        data: function (e, t) {
            var n, r, o, i = this[0],
                a = i && i.attributes;
            if (void 0 === e) {
                if (this.length && (o = V.get(i), 1 === i.nodeType && !X.get(i, "hasDataAttrs"))) {
                    for (n = a.length; n--;) a[n] && 0 === (r = a[n].name).indexOf("data-") && (r = G(r.slice(5)), Q(i, r, o[r]));
            ...
            return "object" == typeof e ? this.each(function () {
                ...
                var n;
                if (i && void 0 === t) return void 0 !== (n = V.get(i, e)) ? n : void 0 !== (n = Q(i, e)) ? n : void 0;
                this.each(function () {
                    V.set(this, e, t)
                })
        ...
        queue: function (e, t, n) {
            var r;
            if (e) return t = (t || "fx") + "queue", r = X.get(e, t), n && (!r || Array.isArray(n) ? r = X.access(e, t, x.makeArray(n)) : r.push(n)), r || []
        },
        ...
        promise: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;)(n = X.get(i[a], e + "queueHooks")) && n.empty && (r++, n.empty.add(s));
    ...
    function se(e, t, n, r) {
        ...
        if (c && c[3] !== l) {
            for (u /= 2, l = l || c[3], c = +u || 1; a--;) x.style(e, t, c + l), (1 - i) * (1 - (i = s() / u || .5)) <= 0 && (a = 0), c /= i;
    ...
    function be(e, t, n, r, o) {
        for (var i, a, s, u, l, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++)
            ...
            for (a = a || f.appendChild(t.createElement("div")), s = (pe.exec(i) || ["", ""])[1].toLowerCase(), u = ge[s] || ge._default, a.innerHTML = u[1] + x.htmlPrefilter(i) + u[2], c = u[0]; c--;) a = a.lastChild;
        ...
        n ? (X.set(e, t, !1), x.event.add(e, t, {
            ...
            handler: function (e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    else if (a = o.call(arguments), X.set(this, t, a), r = n(this, t), this[t](), a !== (i = X.get(this, t)) || r ? X.set(this, t, !1) : i = {}, a !== i) return e.stopImmediatePropagation(), e.preventDefault(), i && i.value
    ...
    x.event = {
        ...
        add: function (e, t, n, r, o) {
            ...
            if (K(e))
                for (n.handler && (n = (i = n).handler, o = i.selector), o && x.find.matchesSelector(re, o), n.guid || (n.guid = x.guid++), (u = m.events) || (u = m.events = Object.create(null)), (a = m.handle) || (a = m.handle = function (t) {
                        return void 0 !== x && x.event.triggered !== t.type ? x.event.dispatch.apply(e, arguments) : void 0
                    }), l = (t = (t || "").match(R) || [""]).length; l--;) p = g = (s = we.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p && (f = x.event.special[p] || {}, p = (o ? f.delegateType : f.bindType) || p, f = x.event.special[p] || {}, c = x.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, i), (d = u[p]) || ((d = u[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && e.addEventListener(p, a)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, c) : d.push(c), x.event.global[p] = !0)
        },
            ...
            if (m && (u = m.events)) {
                for (l = (t = (t || "").match(R) || [""]).length; l--;)
                    if (p = g = (s = we.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
                        for (f = x.event.special[p] || {}, d = u[p = (r ? f.delegateType : f.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = i = d.length; i--;) c = d[i], !o && g !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (d.splice(i, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
            ...
            if (u && l.nodeType && !("click" === e.type && 1 <= e.button))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        for (i = [], a = {}, n = 0; n < u; n++) void 0 === a[o = (r = t[n]).selector + " "] && (a[o] = r.needsContext ? -1 < x(o, this).index(l) : x.find(o, this, null, [l]).length), a[o] && i.push(r);
                        i.length && s.push({
                            elem: l,
                            handlers: i
                        })
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && T(t, "input") && Ee(t, "click", xe), !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && T(t, "input") && Ee(t, "click"), !0
                },
                _default: function (e) {
                    var t = e.target;
        ...
        if (1 === t.nodeType) {
            if (X.hasData(e) && (s = X.get(e).events))
                for (o in X.remove(t, "handle events"), s)
                    for (n = 0, r = s[o].length; n < r; n++) x.event.add(t, o, s[o][n]);
            V.hasData(e) && (i = V.access(e), a = x.extend({}, i), V.set(t, a))
        }
    }
    ...
    function Pe(e, t, n, r) {
        ...
        var o, a, s, u, l, c, f = 0,
            ...
            m = t[0],
            v = h(m);
        if (v || 1 < d && "string" == typeof m && !p.checkClone && Te.test(m)) return e.each(function (o) {
            var i = e.eq(o);
            v && (t[0] = m.call(this, o, i.html())), Pe(i, t, n, r)
        });
        if (d && (a = (o = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === o.childNodes.length && (o = a), a || r)) {
            for (u = (s = x.map(me(o, "script"), Oe)).length; f < d; f++) l = o, f !== g && (l = x.clone(l, !0, !0), u && x.merge(s, me(l, "script"))), n.call(e[f], l, f);
            if (u)
                for (c = s[s.length - 1].ownerDocument, x.map(s, je), f = 0; f < u; f++) l = s[f], he.test(l.type || "") && !X.access(l, "globalEval") && x.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? x._evalUrl && !l.noModule && x._evalUrl(l.src, {
    ...
    function De(e, t, n) {
        for (var r, o = t ? x.filter(t, e) : e, i = 0; null != (r = o[i]); i++) n || 1 !== r.nodeType || x.cleanData(me(r)), r.parentNode && (n && oe(r) && ve(me(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    x.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (i = i || me(e), a = a || me(c), r = 0, o = i.length; r < o; r++) Me(i[r], a[r]);
                else Me(e, c);
    ...
    function Fe(e, t, n) {
        ...
        return (n = n || Ne(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = x.style(e, t)), !p.pixelBoxStyles() && Re.test(a) && qe.test(t) && (r = s.width, o = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = o, s.maxWidth = i)), void 0 !== a ? a + "" : a
    }
    ...
    function Ue(e, t) {
        ...
        c.style && (c.style.backgroundClip = "content-box", c.cloneNode(!0).style.backgroundClip = "", p.clearCloneStyle = "content-box" === c.style.backgroundClip, x.extend(p, {
            ...
            reliableTrDimensions: function () {
                var t, n, r, o;
                return null == s && (t = m.createElement("table"), n = m.createElement("tr"), r = m.createElement("div"), t.style.cssText = "position:absolute;left:-11111px;border-collapse:separate", n.style.cssText = "border:1px solid", n.style.height = "1px", r.style.height = "9px", r.style.display = "block", re.appendChild(t).appendChild(n).appendChild(r), o = e.getComputedStyle(n), s = parseInt(o.height, 10) + parseInt(o.borderTopWidth, 10) + parseInt(o.borderBottomWidth, 10) === n.offsetHeight, re.removeChild(t)), s
            }
        }))
    }();
    ...
    function Ve(e, t, n, r, o, i) {
        ...
        for (; a < 4; a += 2) "margin" === n && (u += x.css(e, n + ne[a], !0, o)), r ? ("content" === n && (u -= x.css(e, "padding" + ne[a], !0, o)), "margin" !== n && (u -= x.css(e, "border" + ne[a] + "Width", !0, o))) : (u += x.css(e, "padding" + ne[a], !0, o), "padding" !== n ? u += x.css(e, "border" + ne[a] + "Width", !0, o) : s += x.css(e, "border" + ne[a] + "Width", !0, o));
    ...
    function Ye(e, t, n) {
        ...
        return (!p.boxSizingReliable() && o || !p.reliableTrDimensions() && T(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === x.css(e, "display", !1, r)) && e.getClientRects().length && (o = "border-box" === x.css(e, "boxSizing", !1, r), (i = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + Ve(e, t, n || (o ? "border" : "content"), i, r, a) + "px"
    }
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, i, a, s = G(t),
                    u = Ge.test(t),
                    l = e.style;
                if (u || (t = We(s)), a = x.cssHooks[t] || x.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, r)) ? o : l[t];
                "string" == (i = typeof n) && (o = te.exec(n)) && o[1] && (n = se(e, t, o), i = "number"), null != n && n == n && ("number" !== i || u || (n += o && o[3] || (x.cssNumber[s] ? "" : "px")), p.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        css: function (e, t, n, r) {
            var o, i, a, s = G(t);
            return Ge.test(t) || (t = We(s)), (a = x.cssHooks[t] || x.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = Fe(e, t, r)), "normal" === o && t in Je && (o = Je[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
        }
    }), x.each(["height", "width"], function (e, t) {
        x.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !ze.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ye(e, t, r) : Ie(e, Ke, function () {
                    return Ye(e, t, r)
                })
            },
            set: function (e, n, r) {
                var o, i = Ne(e),
                    ...
                    u = r ? Ve(e, t, r, s, i) : 0;
                return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - Ve(e, t, "border", !1, i) - .5)), u && (o = te.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = x.css(e, t)), Xe(0, n, u)
            }
        }
        ...
        css: function (e, t) {
            return $(this, function (e, t, n) {
                var r, o, i = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (r = Ne(e), o = t.length; a < o; a++) i[t[a]] = x.css(e, t[a], !1, r);
                    return i
                }
    ...
    var Qe, et, tt, nt, rt = /^(?:toggle|show|hide)$/,
        ot = /queueHooks$/;

    function it() {
        et && (!1 === m.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(it) : e.setTimeout(it, x.fx.interval), x.fx.tick())
    }
    ...
    function lt(e, t, n) {
        var r, o, i = 0,
            ...
            u = function () {
                if (o) return !1;
                for (var t = Qe || at(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), i = 0, a = l.tweens.length; i < a; i++) l.tweens[i].run(r);
        ...
        for (function (e, t) {
                var n, r, o, i, a;
                for (n in e)
                    if (o = t[r = G(n)], i = e[n], Array.isArray(i) && (o = i[1], i = e[n] = i[0]), n !== r && (e[r] = i, delete e[n]), (a = x.cssHooks[r]) && "expand" in a)
                        for (n in i = a.expand(i), delete e[r], i) n in e || (e[n] = i[n], t[n] = o);
                    else t[r] = o
            }(c, l.opts.specialEasing); i < a; i++)
            if (r = lt.prefilters[i].call(l, e, c, l.opts)) return h(r.stop) && (x._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
        return x.map(c, ut, l), h(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), x.fx.timer(x.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
        })), l
    ...
    x.Animation = x.extend(lt, {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (r in n.queue || (null == (a = x._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function () {
                ...
                for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = m && m.display) && (l = X.get(e, "display")), "none" === (c = x.css(e, "display")) && (l ? c = l : (le([e], !0), l = e.style.display || l, c = x.css(e, "display"), le([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === x.css(e, "float") && (u || (d.done(function () {
                        h.display = l
                    }), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always(function () {
                        h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                    })), u = !1, p) u || (m ? "hidden" in m && (g = m.hidden) : m = X.access(e, "fxshow", {
                    display: l
                }), i && (m.hidden = !g), g && le([e], !0), d.done(function () {
                    for (r in g || le([e]), X.remove(e, "fxshow"), p) x.style(e, r, p[r])
                })), u = ut(g ? m[r] : 0, r, d), r in m || (m[r] = u.start, g && (u.end = u.start, u.start = 0))
        }],
    ...
    }, tt = m.createElement("input"), nt = m.createElement("select").appendChild(m.createElement("option")), tt.type = "checkbox", p.checkOn = "" !== tt.value, p.optSelected = nt.selected, (tt = m.createElement("input")).value = "t", tt.type = "radio", p.radioValue = "t" === tt.value;
    ...
    x.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== i && 8 !== i && 2 !== i) return void 0 === e.getAttribute ? x.prop(e, t, n) : (1 === i && x.isXMLDoc(e) || (o = x.attrHooks[t.toLowerCase()] || (x.expr.match.bool.test(t) ? ct : void 0)), void 0 !== n ? null === n ? void x.removeAttr(e, t) : o && "set" in o && void 0 !== (r = o.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (r = o.get(e, t)) ? r : null == (r = x.find.attr(e, t)) ? void 0 : r)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    x.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each(function (n) {
                ...
                var t, o, i, a;
                if (r)
                    for (o = 0, i = x(this), a = mt(e); t = a[o++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
    ...
    x.extend(x.event, {
        trigger: function (t, n, r, o) {
            ...
            if (a = p = s = r = r || m, 3 !== r.nodeType && 8 !== r.nodeType && !yt.test(y + x.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), l = y.indexOf(":") < 0 && "on" + y, (t = t[x.expando] ? t : new x.Event(y, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : x.makeArray(n, [t]), d = x.event.special[y] || {}, o || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                if (!o && !d.noBubble && !g(r)) {
                    for (u = d.delegateType || y, yt.test(u + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a), s = a;
                    s === (r.ownerDocument || m) && v.push(s.defaultView || s.parentWindow || e)
                }
                for (i = 0;
                    (a = v[i++]) && !t.isPropagationStopped();) p = a, t.type = 1 < i ? u : d.bindType || y, (f = (X.get(a, "events") || Object.create(null))[t.type] && X.get(a, "handle")) && f.apply(a, n), (f = l && a[l]) && f.apply && K(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = y, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), n) || !K(r) || l && h(r[y]) && !g(r) && ((s = r[l]) && (r[l] = null), x.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, bt), r[y](), t.isPropagationStopped() && p.removeEventListener(y, bt), x.event.triggered = void 0, s && (r[l] = s)), t.result
            }
        },
    ...
    It.href = wt.href, x.extend({
        ...
        ajax: function (t, n) {
            ...
            var r, o, i, a, s, u, l, c, f, d, p = x.ajaxSetup({}, n),
                h = p.context || p,
                ...
                S = {
                    ...
                    getResponseHeader: function (e) {
                        ...
                        if (l) {
                            if (!a)
                                for (a = {}; t = jt.exec(i);) a[t[1].toLowerCase() + " "] = (a[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = a[e.toLowerCase() + " "]
                        }
            ...
            if (v.promise(S), p.url = ((t || p.url || wt.href) + "").replace(Pt, wt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(R) || [""], null == p.crossDomain) {
                u = m.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = x.param(p.data, p.traditional)), Ft(Dt, p, n, S), l) return S;
            ...
            if (C = "abort", y.add(p.complete), S.done(p.success), S.fail(p.error), r = Ft(Rt, p, n, S)) {
            ...
            function E(t, n, a, u) {
                var f, d, m, w, _, C = n;
                l || (l = !0, s && e.clearTimeout(s), r = void 0, i = u || "", S.readyState = 0 < t ? 4 : 0, f = 200 <= t && t < 300 || 304 === t, a && (w = function (e, t, n) {
                ...
                }(p, S, a)), !f && -1 < x.inArray("script", p.dataTypes) && x.inArray("json", p.dataTypes) < 0 && (p.converters["text script"] = function () {}), w = function (e, t, n, r) {
                    var o, i, a, s, u, l = {},
                        c = e.dataTypes.slice();
                    if (c[1])
    ...
    x.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + o) : !1 !== t.jsonp && (t.url += (_t.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
            return a || x.error(o + " was not called"), a[0]
        }, t.dataTypes[0] = "json", i = e[o], e[o] = function () {
            a = arguments
        }, r.always(function () {
            void 0 === i ? x(e).removeProp(o) : e[o] = i, t[o] && (t.jsonpCallback = n.jsonpCallback, Wt.push(o)), a && h(i) && i(a[0]), a = i = void 0
        }), "script"
    }), p.createHTMLDocument = ((Bt = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Bt.childNodes.length), x.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (p.createHTMLDocument ? ((r = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href, t.head.appendChild(r)) : t = m), i = !n && [], (o = A.exec(e)) ? [t.createElement(o[1])] : (o = be([e], t, i), i && i.length && x(i).remove(), x.merge([], o.childNodes)));
        var r, o, i
    }, x.fn.load = function (e, t, n) {
        var r, o, i, a = this,
            s = e.indexOf(" ");
        return -1 < s && (r = ht(e.slice(s)), e = e.slice(0, s)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < a.length && x.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var r, o, i, a, s, u, l = x.css(e, "position"),
                c = x(e),
                f = {};
            "static" === l && (e.style.position = "relative"), s = c.offset(), i = x.css(e, "top"), u = x.css(e, "left"), ("absolute" === l || "fixed" === l) && -1 < (i + u).indexOf("auto") ? (a = (r = c.position()).top, o = r.left) : (a = parseFloat(i) || 0, o = parseFloat(u) || 0), h(t) && (t = t.call(e, n, x.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, x.fn.extend({
        offset: function (e) {
        ...
        x.cssHooks[t] = Ue(p.pixelPosition, function (e, n) {
            if (n) return n = Fe(e, t), Re.test(n) ? x(e).position()[t] + "px" : n
        })
    }), x.each({
        Height: "height",
        Width: "width"
        ...
        x.each({
            ...
            x.fn[r] = function (o, i) {
                ...
                return $(this, function (t, n, o) {
                    var i;
                    return g(t) ? 0 === r.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (i = t.documentElement, Math.max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : void 0 === o ? x.css(t, n, s) : x.style(t, n, o, s)
                }, t, a ? o : void 0, a)
            }
        })
    ...
    }, x.isArray = Array.isArray, x.parseJSON = JSON.parse, x.nodeName = T, x.isFunction = h, x.isWindow = g, x.camelCase = G, x.type = b, x.now = Date.now, x.isNumeric = function (e) {
        var t = x.type(e);
    ...
    return x.noConflict = function (t) {
        return e.$ === x && (e.$ = Jt), t && e.jQuery === x && (e.jQuery = Kt), x
    ...
    var n = {
            ...
            storeAPI: {
                ...
                namespace: function (e, t) {
                    ...
                    var r = e,
                        o = this[r];
                    if (!(o && o.namespace || (o = n.Store(this._id, this._area, this._ns + r + "."), this[r] || (this[r] = o), t)))
                        for (var i in n.areas) o.area(i, n.areas[i]);
                    return o
                },
                isFake: function () {
                ...
                add: function (e, t) {
                    var r = this.get(e);
                    if (r instanceof Array) t = r.concat(t);
                    else if (null !== r) {
                        var o = typeof r;
                    ...
                    return n.set(this._area, this._in(e), n.stringify(t)), t
                },
                remove: function (e, t) {
                    var r = this.get(e, t);
...
function (e, t) {
    ...
    return function (e) {
        ...
        var r, o, i, a = n(3),
            s = n(0),
            u = Object(s.a)(),
            l = "InstallTrigger" in ((null === u || void 0 === u ? void 0 : u.window) || {}) || /firefox/i.test(a.b),
            c = /trident/i.test(a.b) || /msie/i.test(a.b),
            f = /edge/i.test(a.b),
            d = /webkit/i.test(a.b) && !f,
            p = void 0 !== (null === (r = null === u || void 0 === u ? void 0 : u.window) || void 0 === r ? void 0 : r.chrome) || /chrome/i.test(a.b),
            h = "[object SafariRemoteNotification]" === ((null === (i = null === (o = null === u || void 0 === u ? void 0 : u.window) || void 0 === o ? void 0 : o.safari) || void 0 === i ? void 0 : i.pushNotification) || !1).toString() || /safari/i.test(a.b) && !p
    }, function (e, t, n) {
        "use strict";
        n.d(t, "b", function () {
            return i
        ...
        var r, o = n(0),
            i = Object(o.a)(),
            a = (null === (r = null === i || void 0 === i ? void 0 : i.navigator) || void 0 === r ? void 0 : r.userAgent) || "xxxxx"
    }, function (e, t, n) {
        "use strict";
        n.d(t, "a", function () {
            return r
                ...
                return e.prototype.launch = function () {
                    ...
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    e = !1, t = "", n = 0, r = this._checkers, o.label = 1;
                                case 1:
                                    return n < r.length ? [4, (i = r[n]).isEnable()] : [3, 6];
                                case 2:
                                    return o.sent() ? (t = i.name, [4, i.isOpen()]) : [3, 4];
                                case 3:
                                    e = o.sent(), o.label = 4;
                                case 4:
                                    if (e) return [3, 6];
            ...
            function o(e, o) {
                ...
                if (c && f) {
                    ...
                    for (s = 0; s < Math.max(d.length, p.length); s++) {
                        if (void 0 === d[s] || "string" == typeof p[s] && "number" == typeof d[s]) return -1;
                        if (void 0 === p[s] || "string" == typeof d[s] && "number" == typeof p[s]) return 1;
                        if (d[s] > p[s]) return 1;
                        if (p[s] > d[s]) return -1
                    }
            ...
            isOpen: function () {
                return s(this, void 0, void 0, function () {
                    return u(this, function (e) {
                        return c = !1, Object(o.b)(l), Object(o.a)(), [2, c]
                    })
                })
            },
            isEnable: function () {
        ...
        var f = {
            ...
            isOpen: function () {
                return s(this, void 0, void 0, function () {
                    return u(this, function (e) {
                        return c = 0, Object(o.b)(l), Object(o.a)(), [2, 2 === c]
                    })
                })
            },
            isEnable: function () {
            ...
            isOpen: function () {
                ...
                return r(this, void 0, void 0, function () {
                    ...
                    return o(this, function (t) {
                        return e = i(),
                            function () {}.constructor("debugger")(), [2, i() - e > 100]
                    })
                })
            },
            isEnable: function () {
        ...
        var c = {
            ...
            isOpen: function () {
                return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                        return l = 0, Object(o.b)(u), Object(o.a)(), [2, 2 === l]
                    })
                })
            },
            isEnable: function () {
...
function (e) {
    ...
    a.showPreloader = function (t) {
        ...
        $("body").removeClass("user-preload"), c()
    }, i.emitBootComplete = function () {
        o = 1, i.progress.endPreload(), delete i.emitBootComplete, delete i.boot, delete i.bootModule, delete i.bootSystemJs, delete i.initBoots, delete i.loadAppLibs, delete i.systemBooter, document.body.dispatchEvent(new Event("cgBootComplete")), setTimeout(c, 10)
        ...
        if ((new Date).getTime() < u) setTimeout(e, 30, i, s);
            ...
            c == d.meta.pcode ? o || System.import(i).then(function (e) {
                ...
                a.cgSystemLog(": loading > installed (" + i + "/" + o + ")", "CG." + d.meta.pcode + ".v" + d.meta.ver, {
                    appendHistory: 100
                }), 0 == l.length && (n && n(), n = null, r = null)
            }, console.error.bind(console)) : setTimeout(e, 1, i, s)
        }
    }, i.bootModule = d, i.loadAppLibs = function (o, s, l) {
        ...
        i.progress.total += r.cg.length + r.js.length,
            function e(t, n, r) {
                ...
                o.appLibs && o.appLibs.length ? (s && (u = s), n = l, g(o.appLibs.slice()), f ? $.loadLibrary(f.js, function () {
...
function (e, t, n) {
    ...
    var v = function (e) {
            return m(m(m(m(m(btoa(JSON.stringify(e)), ["0", "9"]), ["1", "2"]), ["a", "Z"]), ["z", "A"]), ["i", "I"])
        },
        y = function (e) {
    ...
    a.push(function (e) {
        o = e.projectCode, e.homeUrl.replace(/\/$/, ""), r = e.svrUrl.replace(/\/$/, ""), l = "prod" == e.env, c = 1 == e.svr_recorder, l && (C = Date.now() + 20, y(30).then(E))
    });
    ...
    e.addEventListener("pointermove", x, !0), e.addEventListener("pointerdown", x, !0), e.addEventListener("keydown", x, !0);
    var _ = null,
        C = 0,
        S = [],
        E = function () {
            C = C || Date.now();
            var r, i = u(o + "AToken") || "";
            (r = i, r ? _ && _.token == r ? Promise.resolve(_.user) : new Promise(e => {
                b("/get/my_user_by_token/" + o, {
                    token: r
                }, function (t) {
                    t && t.user ? (_ = {
                        user: t.user,
            ...
            }) : Promise.resolve(_ = null)).then(r => (function () {
                if (k) return Promise.resolve(k);
                return function (e) {
                    var r = A(e);
                    if (r) return Promise.resolve(r);
                    return T ? (r = A(T.contentWindow), Promise.resolve(r)) : new Promise(function (e) {
                        var r = "iframe" + g,
                            o = n(`<iframe id="${r}" sandbox="allow-same-origin" style="display: none"></iframe>`);
                        o.appendTo("body"), o.ready(function () {
                            T = t.getElementById(r), e(A(T.contentWindow))
                        })
                    })
                }(e).then(function (e) {
                    return function (e) {
                        ...
                        return o.onicecandidate = function (e) {
                            ...
                            o.setLocalDescription(e, L, L)
                        }, L), y(3).then(function () {
                            return o.localDescription.sdp.split("\n").forEach(function (e) {
                                0 === e.indexOf("a=candidate:") && a(e)
                            }), T && (n(T).remove(), T = null), i ? Object.keys(t) : O(t)
                        })
                    }(e)
                }).then(function (e) {
                    return e.length && ((k = {
                ...
                if (n) {
                    var a = s.platform;
                    e.device && e.device.platform && (a = e.device.platform), n.platform = a;
                    var l = v(n);
                    u("gltmsrec", l), i = r && i || "";
                    var p = {
                        duration: 0,
                    ...
                    if (!t.hidden && (w > C || c) && (p.duration = Math.ceil((Date.now() - C) / 1e3)), S.includes(i) || (S.push(i), p.plays = 1), C = Date.now(), p.duration || p.plays) {
                        f += p.duration;
                        var h = v(p);
                        b(d + o, {
                            token: i,
                            ...
                            e && e.dura && e.dura < 180 ? t = Math.min(30 + 30 * Math.random(), 181 - e.dura + 5 * Math.random()) : f < 300 && (t = 30 + 90 * Math.random()), y(t).then(E)
                        })
                    } else y(30).then(E)
                } else y(15).then(E)
            })).catch(e => {
...
function (e, t) {
    var n, r, o, i, a, s, u, l, c, f = Math.random() + 6e4,
    ...
    function h(e) {
        ...
        var p;
        n = f.homeUrl.replace(/\/$/, ""), "prod" == f.env && "block" == f[atob("ZGV2dG9vbHNQb2xpY3k=")] && (p = JSON.parse(atob("WyJrZXkiLCJrZXlDb2RlIiwxMjMsIkYxMiIsIm9ua2V5ZG93biIsImxvY2F0aW9uIiwiaHJlZiJd")), r = p[0], o = p[1], i = p[2], a = p[3], s = p[4], u = p[5], l = p[6], c = Date.now(), d.addListener(function (t) {
            if (t) {
                try {
                    h(e.top)
                } catch (e) {}
...
function () {
    ...
    if (a) {
        var l = (a = a.split("#")[0].split("?")[0]).lastIndexOf("/"); - 1 !== l && (a = a.substr(0, l + 1))
    } else {
    ...
    function h(e, n) {
        ...
        if ("." === o && ("/" === i || "." === i && ("/" === e[2] || 2 === e.length && (e += "/")) || 1 === e.length && (e += "/")) || "/" === o) {
            ...
            return -1 !== c && l.push(u.substr(c)), n.substr(0, n.length - a.length) + l.join("")
        }
    ...
    function y(e) {
        if (void 0 !== e) {
            if (e instanceof k == !1 && "module" !== e[s]) throw new TypeError("Module instantiation did not return a valid namespace object.");
            return e
        }
    }
    v.prototype.constructor = v, v.prototype.import = function (e, t) {
    ...
    _ && (S.prototype[Symbol.iterator] = function () {
        ...
        if (!(t instanceof k || "module" === t[s])) throw new Error("Registry must be set with an instance of Module Namespace");
    ...
    k.prototype = Object.create(null), s && Object.defineProperty(k.prototype, s, {
        value: "Module"
    });
    ...
    O.prototype = Object.create(v.prototype), O.prototype.constructor = O;
    ...
    function P(e, t, n, o, i) {
        return n.instantiatePromise || (n.instantiatePromise = (t.registration ? A : A.then(function () {
            return i.lastRegister = void 0, e[j](t.key, e[j].length > 1 && function (e, t, n) {
                return function () {
            ...
            if (void 0 !== a) {
                if (!(a instanceof k || "module" === a[s])) throw new TypeError("Instantiate did not return a valid Module object.");
    ...
    function q(e, t, n, r, o, i) {
        for (var a, u, l = 0; l < n.dependencies.length; l++) {
            ...
            if (!((c = n.dependencyInstantiations[l]) instanceof k || "module" === c[s]) && (a = c.linkRecord))
                if (c.evalError) I(t, c.evalError);
                else if (a.setters) {
                if (-1 === i.indexOf(c)) {
                    i.push(c);
                    try {
        ...
        if (u) return n.evaluatePromise = Promise.all(u).then(function () {
            if (n.execute) {
                ...
                if (e) return e.catch(function (e) {
                    ...
                    return t.linkRecord = void 0, r[t.key] = t.module = new k(n.moduleObj)
                })
            }
            t.linkRecord = void 0, r[t.key] = t.module = new k(n.moduleObj)
        });
        if (n.execute) {
            try {
    ...
    function F(e, t, n, o, i, a) {
        ...
        var c = function (e, t, n, r, o, i, a) {
            return function (u) {
                for (var l = 0; l < n.length; l++)
                    if (n[l] === u) {
                        var c, f = r[l];
                        if (f instanceof k || "module" === f[s]) c = f;
                        else {
                            if (f.evalError) throw f.evalError;
                            void 0 !== f.module || -1 !== a.indexOf(f) || f.linkRecord.evaluatePromise || (f.linkRecord.setters ? q(e, f, f.linkRecord, o, i, [f]) : (a.push(f), F(e, f, f.linkRecord, o, i, a))), c = f.module || f.linkRecord.moduleObj
                        }
        ...
        if (!n.executingRequire)
            for (var f = 0; f < n.dependencies.length; f++) c(n.dependencies[f]);
        try {
        ...
        t.linkRecord = void 0, u.exports !== l.__useDefault && (l.default = l.__useDefault = u.exports);
        var p = l.default;
        if (p && p.__esModule)
            for (var h in p) Object.hasOwnProperty.call(p, h) && (l[h] = p[h]);
        if (o[t.key] = t.module = new k(n.moduleObj), t.importerSetters)
    ...
    O.prototype[O.resolve = v.resolve] = function (e, t) {
        return h(e, t || a)
    }, O.prototype[j] = function (e, t) {}, O.prototype[v.resolveInstantiate] = function (e, t) {
        var n = this,
            r = this[L],
            o = this.registry[C];
        return function (e, t, n, r, o) {
            ...
            var a = o.records[t];
            if (a && !a.module) return a.loadError ? Promise.reject(a.loadError) : P(e, a, a.linkRecord, r, o);
            return e.resolve(t, n).then(function (t) {
                if (i = r[t]) return i;
                if ((a = o.records[t]) && !a.module || (a = M(o, t, a && a.registration)), a.loadError) return Promise.reject(a.loadError);
                var n = a.linkRecord;
                return n ? P(e, a, n, r, o) : a
            })
        }(n, e, t, o, r).then(function (e) {
            if (e instanceof k || "module" === e[s]) return e;
            var t = e.linkRecord;
            if (!t) {
            ...
            return function (e, t, n, r, o) {
                ...
                return function t(n, a) {
                    if (!a) return A;
                    if (-1 !== i.indexOf(n)) return A;
                    i.push(n);
                    return function (e, t, n, r, o) {
                        if (n.depsInstantiatePromise) return n.depsInstantiatePromise;
                        for (var i = Array(n.dependencies.length), a = 0; a < n.dependencies.length; a++) i[a] = D(e, n.dependencies[a], t.key, r, o, e.trace && n.depMap || (n.depMap = {}));
                        var u = Promise.all(i).then(function (e) {
                            if (n.dependencyInstantiations = e, n.setters)
                                for (var r = 0; r < e.length; r++) {
                                    ...
                                    if (o) {
                                        var i = e[r];
                                        if (i instanceof k || "module" === i[s]) o(i);
                                        else {
    ...
    function $() {}
    var B = new k({});
    var W, z = i("loader-config"),
        G = i("metadata"),
        K = "undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts;
    ...
    function ee(e) {
        if (Z || Q) {
            ...
            Z ? (t.rel = "preload", t.as = "script") : t.rel = "prefetch", t.href = e, document.head.appendChild(t)
        } else {
            (new Image).src = e
        }
    }
    ...
    function ne(e, t, n, r, o) {
        if (e = e.replace(/#/g, "%23"), K) return function (e, t, n) {
            try {
                importScripts(e)
            } catch (e) {
                n(e)
    ...
    var fe = "undefined" != typeof XMLHttpRequest,
        ...
        pe = "undefined" != typeof self && void 0 !== self.fetch ? le : fe ? ce : "undefined" != typeof require && "undefined" != typeof process ? function (e, t, r, o) {
            return "file:///" != e.substr(0, 8) ? de ? le(e, t, r, o) : Promise.reject(new Error('Unable to fetch "' + e + '". Only file URLs of the form file:/// supported running in Node without fetch.')) : (se = se || require("fs"), e = n ? e.replace(/\//g, "\\").substr(8) : e.substr(7), new Promise(function (t, n) {
    ...
    function ve(e, t, n, r, o, i) {
        ...
        var l = me.call(this, e, t, n, !0, !0),
            c = Te(e, l);
        if (r.packageKey = c && c.packageKey || ae(e.packages, l), !r.packageKey) return l;
        if (-1 !== e.packageConfigKeys.indexOf(l)) return r.packageKey = void 0, l;
        ...
        return function (e, t, n, r, o, i, a) {
            ...
            if (n.map) {
                var s = "./" + o,
                    u = ae(n.map, s);
                if (u || (s = "./" + _e(t, n, r, o, a)) !== "./" + o && (u = ae(n.map, s)), u) {
        ...
        return H.then(function () {
            ...
            return r.packageKey = u && u.packageKey || ae(e.packages, s), r.packageKey ? -1 !== e.packageConfigKeys.indexOf(s) ? (r.packageKey = void 0, r.load = be(), r.load.format = "json", r.load.loader = "", Promise.resolve(s)) : (r.packageConfig = e.packages[r.packageKey] || (e.packages[r.packageKey] = Ie()), (u && !r.packageConfig.configured ? function (e, t, n, r, o) {
                ...
                return function (e, t, n, r, o, i, a) {
                    ...
                    var s, u;
                    n.map && (s = "./" + o, (u = ae(n.map, s)) || (s = "./" + _e(t, n, r, o, a)) !== "./" + o && (u = ae(n.map, s)));
    ...
    function Se(e, t, n, r, o, i, a, s) {
        ...
        if (Ce(o, u, i) && "string" == typeof u) return ve.call(e, t, u + i.substr(o.length), r + "/", a, a, s)
    }
    ...
    function Ee(e, t, n, r, o, i, a, s) {
        ...
        return Promise.all(l).then(function (e) {
            for (var t = 0; t < c.length; t++) {
                ...
                if (!n.negate && r || n.negate && !r) return c[t].map
            }
        }).then(function (n) {
    ...
    function Te(e, t) {
        for (var n, r, o, i, a, s = !1, u = 0; u < e.packageConfigPaths.length; u++) {
            var l = e.packageConfigPaths[u],
                c = ke[l] || (ke[l] = (void 0, void 0, i = (o = l).lastIndexOf("*"), {
            ...
            if (!(t.length < c.length)) {
                ...
                !f || n && (s && c.wildcard || !(n.length < f[1].length)) || (n = f[1], s = !c.wildcard, r = n + l.substr(c.length))
            }
        }
        if (n) return {
            packageKey: n,
    ...
    function Oe(e) {
        ...
        return -1 !== o ? (t = e.substr(o + 1), n = e.substr(0, o), "~" === t[0] && (r = !0, t = t.substr(1))) : (r = "~" === e[0], t = "default", n = e.substr(r), -1 !== Le.indexOf(n) && (t = n, n = null)), {
            module: n || "@system-env",
            prop: t,
            negate: r
        }
    ...
    function ze(e, t, n, r) {
        ...
        return (r ? "(function(System, SystemJS) {" : "") + e + (r ? "\n})(System, System);" : "") + ("\n//# sourceURL=" != e.substr(i, 15) ? "\n//# sourceURL=" + n + (t ? "!transpiled" : "") : "") + (t && (o = t, Fe ? We + new Buffer(o).toString("base64") : "undefined" != typeof btoa ? We + btoa(unescape(encodeURIComponent(o))) : "") || "")
    }
    var Ge = 0;

    function Ke(e) {
        0 == Ge++ && (Be = r.System), r.System = r.SystemJS = e
    }
        ...
        if (t) {
            if (i && Ve) return function (e, t, n, r, o) {
                ...
                if (window.onerror = function (e) {
                    ...
                    }, Ke(e), o && i.setAttribute("nonce", o), Ue.appendChild(i), Ue.removeChild(i), Je(), window.onerror = s, a) return a
            }(e, t, n, r, i);
            try {
                Ke(e), !He && e._nodeRequire && (He = e._nodeRequire("vm"), $e = He.runInThisContext("typeof System !== 'undefined' && System") === e), $e ? He.runInThisContext(ze(t, n, r, !a), {
    ...
    function Ze(e) {
        function t(n, r, o, i) {
            ...
            for (var u = [], l = 0; l < n.length; l++) u.push(e.import(n[l], i));
        ...
        function n(n, o, i) {
            ...
            function l(n, l, c) {
                ...
                if (c.uri = c.id, c.config = $, -1 !== u && f.splice(u, 0, c), -1 !== s && f.splice(s, 0, l), -1 !== a) {
                ...
                r.require = h, void 0 !== g && (c.exports = g)
            }
            "string" != typeof n && (i = o, o = n, n = null), o instanceof Array || (o = ["require", "exports", "module"].splice(0, (i = o).length)), "function" != typeof i && (i = function (e) {
            ...
            }(i)), n || mt && (o = o.concat(mt), mt = void 0), -1 !== (a = o.indexOf("require")) && (o.splice(a, 1), n || (o = o.concat(function (e, t) {
                ...
                return i
            }(i.toString(), a)))), -1 !== (s = o.indexOf("exports")) && o.splice(s, 1), -1 !== (u = o.indexOf("module")) && o.splice(u, 1), n ? (e.registerDynamic(n, o, !1, l), gt ? (gt = void 0, vt = !0) : vt || (gt = [o, l])) : e.registerDynamic(o, !1, yt ? ht(l) : l)
        }
    ...
    function _t(e, t, n, o, i) {
        return Promise.resolve(n).then(function (t) {
                    ...
                    for (var r = n[0].match(Dt), o = 0; o < r.length; o++) {
                        ...
                        if (";" == i.substr(a - 1, 1) && a--, '"' == s || "'" == s) {
                            ...
                            if (l) {
                                ...
                                "deps" === l && (l = "deps[]"), "[]" === l.substr(l.length - 2, 2) ? (l = l.substr(0, l.length - 2), t.load[l] = t.load[l] || [], t.load[l].push(c)) : "use" !== l && Rt(t.load, l, c)
                            } else t.load[u] = !0
                        }
                    }
            ...
            return o.load.format || '"bundle"' !== n.substring(0, 8) ? "register" === o.load.format || !o.load.format && kt(n) ? (o.load.format = "register", n) : "esm" === o.load.format || !o.load.format && n.match(St) ? (o.load.format = "esm", function (e, t, n, r, o) {
                ...
                return e.import.call(e, e.transpiler).then(function (o) {
                    ...
                    return o === r.pluginModule ? t : ("string" == typeof r.load.sourceMap && (r.load.sourceMap = JSON.parse(r.load.sourceMap)), r.pluginLoad = r.pluginLoad || {
                        ...
                        return t && "object" == typeof t && Ot(n, t), "esm" === r.load.format && kt(e) && (r.load.format = "register"), e
                    }))
                }, function (e) {
            ...
            return o.pluginLoad.source = t, Promise.resolve(o.pluginModule.instantiate.call(e, o.pluginLoad, function (e) {
                ...
                return n ? t : function (e) {
                    if (e) {
                        if (e instanceof k || "module" === e[s]) return e;
                        if (e.__esModule) return new k(e)
                    }
                    return new k({
                        default: e,
                        __useDefault: e
            ...
            o.load.format || (o.load.format = function (e) {
                return e.match(Tt) ? "amd" : (At.lastIndex = 0, ue.lastIndex = 0, ue.exec(e) || At.exec(e) ? "cjs" : "global")
            }(n));
            var a = !1;
            switch (o.load.format) {
                ...
                case "register":
                case "system":
                    if (l = Ye(e, n, o.load.sourceMap, t, o.load.integrity, o.load.nonce, !1)) throw l;
                    return i() ? void 0 : B;
                case "json":
                    var s = JSON.parse(n);
                    return e.newModule({
                ...
                case "cjs":
                    ...
                    e.registerDynamic(f, !0, function (i, a, s) {
                        if (i.resolve = function (t) {
                            ...
                            }, s.paths = [], s.require = i, !o.load.cjsDeferDepsExecute && c)
                        ...
                        var h = r.define;
                        r.define = void 0, r.__cjsWrapper = f, n = d + ") {" + n.replace(Lt, "") + "\n}).apply(__cjsWrapper.exports, __cjsWrapper.args);";
                        var g = Ye(e, n, o.load.sourceMap, t, o.load.integrity, o.load.nonce, !1);
                        if (g) throw g;
                        xt(o, a), r.__cjsWrapper = void 0, r.define = h
                    }), a = i();
                    break;
                case "global":
                    f = o.load.deps || [];
    ...
    if ("undefined" != typeof document) {
        var Nt = document.getElementsByTagName("script"),
            It = Nt[Nt.length - 1];
        document.currentScript && (It.defer || It.async) && (It = document.currentScript), jt = It && It.src
    ...
    } else "undefined" != typeof __filename && (jt = __filename);

    function qt() {
        var e;
        O.call(this), this._loader = {}, this[G] = {}, this[z] = {
            baseURL: a,
            paths: {},
            packageConfigPaths: [],
            packageConfigKeys: [],
            ...
            pluginFirst: !1,
            wasm: !1
        }, this.scriptSrc = jt, this._nodeRequire = bt, this.registry.set("@empty", B), Ft.call(this, !1, !1), (e = this).set("@@cjs-helpers", e.newModule({
    ...
    function Ft(t, n) {
        this[z].production = t, this.registry.set("@system-env", Mt = this.newModule({
            browser: e,
    ...
    qt.prototype = Object.create(O.prototype), qt.prototype.constructor = qt, qt.prototype[qt.resolve = O.resolve] = qt.prototype.normalize = function (e, t) {
        var n = this[z],
            r = {
                pluginKey: void 0,
                pluginArgument: void 0,
            ...
            return function (e, t, n) {
                ...
                for (var i in e.meta)
                    if (-1 !== (r = i.indexOf("*")) && i.substr(0, r) === t.substr(0, r) && i.substr(r + 1) === t.substr(t.length - i.length + r + 1)) {
                        ...
                        a > o && (o = a), Y(n.load, e.meta[i], o !== a)
                    } if (e.meta[t] && Y(n.load, e.meta[t], !1), n.packageKey) {
        ...
        return a ? (o.pluginKey = e.call(this, a.plugin, n), xe(r.pluginFirst, ve.call(this, r, a.argument, i.pluginArgument || n, o, i, !!o.pluginKey), o.pluginKey)) : ve.call(this, r, t, i.pluginArgument || n, o, i, !!o.pluginKey)
        ...
        return (function (t, n, r) {
            ...
            if (!o()) {
                ...
                return s.load.scriptLoad ? !s.pluginKey && wt || (s.load.scriptLoad = !1, J.call(a, 'scriptLoad not supported for "' + t + '"')) : !1 !== s.load.scriptLoad && !s.pluginKey && wt && (s.load.deps || s.load.globals || !("system" === s.load.format || "register" === s.load.format || "global" === s.load.format && s.load.exports) || (s.load.scriptLoad = !0)), s.load.scriptLoad ? new Promise(function (e, n) {
                    ...
                    return function (t, n, r, o, i) {
                        return r.load.exports && !r.load.format && (r.load.format = "global"), H.then(function () {
            ...
            return delete i[G][t], e
        })
    }, qt.prototype.config = function (e, t) {
        var n, r = this,
            o = this[z];
        if ("warnings" in e && (o.warnings = e.warnings), "wasm" in e && (o.wasm = "undefined" != typeof WebAssembly && e.wasm), ("production" in e || "build" in e) && Ft.call(r, !!e.production, !!(e.build || Mt && Mt.build)), !t)
        ...
        if (e.bundles)
            for (var i in e.bundles) {
                var m = [];
                for (f = 0; f < e.bundles[i].length; f++) m.push(r.normalizeSync(e.bundles[i][f]));
                o.bundles[i] = m
            }
        if (e.packages)
            for (var i in e.packages) {
                ...
                var v;
                v = (v = me.call(r, o, "/" !== i[i.length - 1] ? i + "/" : i, void 0, !0, !0)).substr(0, v.length - 1), qe(o.packages[v] = o.packages[v] || {
                    defaultExtension: void 0,
                    main: void 0,
                    format: void 0,
                    meta: void 0,
        ...
        if (e.meta)
            for (var i in e.meta)
                ...
                } for (var b in "transpiler" in e && (o.transpiler = e.transpiler), e) - 1 === Ut.indexOf(b) && -1 === De.indexOf(b) && (r[b] = e[b]);
        Re(0, e, function (e) {
            r.config(e, !0)
        })
    }, qt.prototype.getConfig = function (e) {
        if (e) {
            if (-1 !== Ut.indexOf(e)) return Ne(this[z], e);
    ...
    for (var Ut = ["baseURL", "map", "paths", "packages", "packageConfigPaths", "depCache", "meta", "bundles", "transpiler", "warnings", "pluginFirst", "production", "wasm"], Ht = "undefined" != typeof Proxy, $t = 0; $t < Ut.length; $t++) ! function (e) {
    ...
    qt.prototype.delete = function (e) {
        return Bt(this, "delete"), this.registry.delete(e)
    }, qt.prototype.get = function (e) {
        return Bt(this, "get"), this.registry.get(e)
    }, qt.prototype.has = function (e) {
        return Bt(this, "has"), this.registry.has(e)
    }, qt.prototype.set = function (e, t) {
        return Bt(this, "set"), this.registry.set(e, t)
        ...
        return "string" == typeof e && (e = ge.call(this, this[z], e)), O.prototype.register.call(this, e, t, n)
    }, qt.prototype.registerDynamic = function (e, t, n, r) {
        return "string" == typeof e && (e = ge.call(this, this[z], e)), O.prototype.registerDynamic.call(this, e, t, n, r)
    }, qt.prototype.version = "0.21.6 Dev";
    var Wt = new qt;
    (e || K) && (r.SystemJS = r.System = Wt), "undefined" != typeof module && module.exports && (module.exports = Wt)
}(),
function (e, t) {
    ...
    function d(r) {
        ...
        l().includes(i) && (d = 0), c(s, s.appResourcePack.resourceMap), c(s, s.appLibs), c(s, s.srcUrlMap), t.CgApp = {
...
function (e, t) {
    ...
    return function (e) {
        ...
        const s = function (e) {
            ...
            return function (n) {
                for (let e = 0; e < t.length; e++)
                    if (t[e].input === n) {
                        const n = t[0];
                        return t[0] = t[e], t[e] = n, t[0].result
                    } const r = e(n);
                return t.unshift({
                    input: n,
                    result: r
            ...
            let u = 0,
                l = 0;
            for (;;) {
                if (u = l, -1 === (l = n.indexOf("/", u))) {
                    s.push(n.slice(u));
                    break
                }
                for (s.push(n.slice(u, l)); l < n.length && "/" === n[l];) l++
            }
            let c = 0;
            for (l = s.length - 1; l >= 0; l--) {
                const e = s[l];
                "." === e ? s.splice(l, 1) : ".." === e ? c++ : c > 0 && ("" === e ? (s.splice(l + 1, c), c = 0) : (s.splice(l, 2), c--))
            }
            return "" === (n = s.join("/")) && (n = a ? "/" : "."), r ? (r.path = n, i(r)) : n
        });
        ...
        t.normalize = s, t.join = u, t.isAbsolute = function (e) {
        ...
        t.toSetString = l ? c : function (e) {
            ...
            if (t = t || "", e && ("/" !== e[e.length - 1] && "/" !== t[0] && (e += "/"), t = e + t), n) {
                const e = o(n);
                if (!e) throw new Error("sourceMapURL could not be parsed");
                if (e.path) {
        ...
        class s {
            ...
            applySourceMap(e, t, n) {
                ...
                this._mappings.unsortedForEach(function (t) {
                    if (t.source === r && null != t.originalLine) {
                        ...
                        null != r.source && (t.source = r.source, null != n && (t.source = o.join(n, t.source)), null != a && (t.source = o.relative(a, t.source)), t.originalLine = r.line, t.originalColumn = r.column, null != r.name && (t.name = r.name))
                    }
                    const i = t.source;
            ...
            _validateMapping(e, t, n, r) {
                ...
                else if (!(e && "line" in e && "column" in e && t && "line" in t && "column" in t && e.line > 0 && e.column >= 0 && t.line > 0 && t.column >= 0 && n)) throw new Error("Invalid mapping: " + JSON.stringify({
                    generated: e,
                    source: n,
                    original: t,
                    name: r
            ...
            _serializeMappings() {
                ...
                for (let h = 0, g = p.length; h < g; h++) {
                    ...
                    e += r.encode(t.generatedColumn - a), a = t.generatedColumn, null != t.source && (i = this._sources.indexOf(t.source), e += r.encode(i - f), f = i, e += r.encode(t.originalLine - 1 - l), l = t.originalLine - 1, e += r.encode(t.originalColumn - u), u = t.originalColumn, null != t.name && (n = this._names.indexOf(t.name), e += r.encode(n - c), c = n)), d += e
                }
                return d
            }
        ...
        (function (t) {
            if ("function" == typeof fetch) {
                let t = null;
                e.exports = function () {
                    if ("string" != typeof t) throw new Error("You must provide the URL of lib/mappings.wasm by calling SourceMapConsumer.initialize({ 'lib/mappings.wasm': ... }) before using SourceMapConsumer");
        ...
        t.SourceMapGenerator = n(1).SourceMapGenerator, t.SourceMapConsumer = n(8).SourceMapConsumer, t.SourceNode = n(13).SourceNode
    }, function (e, t) {
        ...
        class l {
            ...
            static with(e, t, n) {
                let r = null;
                return new l(e, t).then(e => (r = e, n(e))).then(e => (r && r.destroy(), e), e => {
                    throw r && r.destroy(), e
                })
            }
            _parseMappings(e, t) {
        ...
        l.prototype._version = 3, l.GENERATED_ORDER = 1, l.ORIGINAL_ORDER = 2, l.GREATEST_LOWER_BOUND = 1, l.LEAST_UPPER_BOUND = 2, t.SourceMapConsumer = l;
        class c extends l {
            constructor(e, t) {
                return super(u).then(n => {
                    ...
                    if (a != n._version) throw new Error("Unsupported version: " + a);
                    return c && (c = r.normalize(c)), u = u.map(String).map(r.normalize).map(function (e) {
                        return c && r.isAbsolute(c) && r.isAbsolute(e) ? r.relative(c, e) : e
                    }), n._names = i.fromArray(l.map(String), !0), n._sources = i.fromArray(u, !0), n._absoluteSources = n._sources.toArray().map(function (e) {
                        return r.computeSourceURL(c, e, t)
                    }), n.sourceRoot = c, n.sourcesContent = f, n._mappings = d, n._sourceMapURL = t, n.file = p, n._computedColumnSpans = !1, n._mappingsPtr = 0, n._wasm = null, s().then(e => (n._wasm = e, n))
                })
            }
            _findSourceIndex(e) {
                let t = e;
                if (null != this.sourceRoot && (t = r.relative(this.sourceRoot, t)), this._sources.has(t)) return this._sources.indexOf(t);
            ...
            _getMappingsPtr() {
                return 0 === this._mappingsPtr && this._parseMappings(this._mappings, this.sourceRoot), this._mappingsPtr
            }
            _parseMappings(e, t) {
                const n = e.length,
            ...
            eachMapping(e, t, n) {
                ...
                this._wasm.withMappingCallback(t => {
                    null !== t.source && (t.source = this._sources.at(t.source), t.source = r.computeSourceURL(a, t.source, this._sourceMapURL), null !== t.name && (t.name = this._names.at(t.name))), e.call(o, t)
                }, () => {
                    switch (i) {
            ...
            allGeneratedPositionsFor(e) {
                ...
                if (o < 0) throw new Error("Column numbers must be >= 0");
                const i = [];
                return this._wasm.withMappingCallback(e => {
                    let t = e.lastGeneratedColumn;
                    this._computedColumnSpans && null === t && (t = 1 / 0), i.push({
                        line: e.generatedLine,
                        column: e.generatedColumn,
                        lastColumn: t
                    })
            ...
            destroy() {
                0 !== this._mappingsPtr && (this._wasm.exports.free_mappings(this._mappingsPtr), this._mappingsPtr = 0)
            }
            computeColumnSpans() {
            ...
            originalPositionFor(e) {
                ...
                if (null == o && (o = l.GREATEST_LOWER_BOUND), this._wasm.withMappingCallback(e => n = e, () => {
                    ...
                    null !== e && (e = this._sources.at(e), e = r.computeSourceURL(this.sourceRoot, e, this._sourceMapURL));
            ...
            sourceContentFor(e, t) {
                ...
                if (null != this.sourceRoot && (i = r.relative(this.sourceRoot, i)), null != this.sourceRoot && (o = r.urlParse(this.sourceRoot))) {
                    ...
                    if ("file" == o.scheme && this._sources.has(e)) return this.sourcesContent[this._sources.indexOf(e)];
            ...
            generatedPositionFor(e) {
                ...
                if (null == i && (i = l.GREATEST_LOWER_BOUND), this._wasm.withMappingCallback(e => o = e, () => {
        ...
        c.prototype.consumer = l, t.BasicSourceMapConsumer = c;
        class f extends l {
            constructor(e, t) {
                return super(u).then(n => {
                    let o = e;
                    ...
                    if (a != n._version) throw new Error("Unsupported version: " + a);
                    n._sources = new i, n._names = new i, n.__generatedMappings = null, n.__originalMappings = null, n.__generatedMappingsUnsorted = null, n.__originalMappingsUnsorted = null;
                    let u = {
                        line: -1,
                        column: 0
                    };
                    return Promise.all(s.map(e => {
                        ...
                        return u = n, new l(r.getArg(e, "map"), t).then(e => ({
                            generatedOffset: {
                                generatedLine: o + 1,
                                generatedColumn: i + 1
                            },
            ...
            _sortGeneratedMappings() {
                ...
                e.sort(r.compareByGeneratedPositionsDeflated), this.__generatedMappings = e
            }
            _sortOriginalMappings() {
                const e = this._originalMappingsUnsorted;
                e.sort(r.compareByOriginalPositions), this.__originalMappings = e
            }
            get sources() {
                const e = [];
                for (let t = 0; t < this._sections.length; t++)
                    for (let n = 0; n < this._sections[t].consumer.sources.length; n++) e.push(this._sections[t].consumer.sources[n]);
                return e
            }
            originalPositionFor(e) {
                const t = {
            ...
            generatedPositionFor(e) {
                for (let t = 0; t < this._sections.length; t++) {
                    ...
                    if (-1 === n.consumer._findSourceIndex(r.getArg(e, "source"))) continue;
            ...
            _parseMappings(e, t) {
                ...
                for (let e = 0; e < this._sections.length; e++) {
                    ...
                    for (let e = 0; e < i.length; e++) {
                        ...
                        this._sources.add(s), s = this._sources.indexOf(s);
                        let u = null;
                        a.name && (this._names.add(a.name), u = this._names.indexOf(a.name));
                        const l = {
                            source: s,
                        ...
                        n.push(l), "number" == typeof l.originalLine && o.push(l)
                    }
                }
            }
            eachMapping(e, t, n) {
                ...
                i.map(function (e) {
                    let t = null;
                    return null !== e.source && (t = this._sources.at(e.source), t = r.computeSourceURL(a, t, this._sourceMapURL)), {
                        source: t,
                ...
                if (a >= 0) {
                    ...
                    if (void 0 === e.column) {
                        ...
                        for (; n && n.originalLine === e;) {
                            ...
                            this._computedColumnSpans && null === e && (e = 1 / 0), i.push({
            ...
            return o = r().then(t => WebAssembly.instantiate(t, {
                env: {
                    mapping_callback(t, n, r, o, i, a, s, u, l, c) {
                        ...
                        f.generatedLine = t + 1, f.generatedColumn = n, r && (f.lastGeneratedColumn = o - 1), i && (f.source = a, f.originalLine = s + 1, f.originalColumn = u, l && (f.name = c)), e[e.length - 1](f)
                    },
        ...
        class u {
            constructor(e, t, n, r, o) {
                this.children = [], this.sourceContents = {}, this.line = null == e ? null : e, this.column = null == t ? null : t, this.source = null == n ? null : n, this.name = null == o ? null : o, this[s] = !0, null != r && this.add(r)
            }
                ...
                return t.eachMapping(function (e) {
                    if (null !== p) {
                        if (!(f < e.generatedLine)) {
                            ...
                            return a[s] = c.substr(e.generatedColumn - d), d = e.generatedColumn, h(p, t), void(p = e)
                        }
                        h(p, l()), f++, d = 0
                    }
                    for (; f < e.generatedLine;) r.add(l()), f++;
                    d < e.generatedColumn && (c = a[s] || "", r.add(c.substr(0, e.generatedColumn)), a[s] = c.substr(e.generatedColumn), d = e.generatedColumn), p = e
            ...
            prepend(e) {
                if (Array.isArray(e))
                    for (let t = e.length - 1; t >= 0; t--) this.prepend(e[t]);
                else {
                    if (!e[s] && "string" != typeof e) throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + e);
            ...
            walk(e) {
                let t;
                for (let n = 0, r = this.children.length; n < r; n++)(t = this.children[n])[s] ? t.walk(e) : "" !== t && e(t, {
                    source: this.source,
                    line: this.line,
                    column: this.column,
                    name: this.name
            ...
            walkSourceContents(e) {
                for (let t = 0, n = this.children.length; t < n; t++) this.children[t][s] && this.children[t].walkSourceContents(e);
                const t = Object.keys(this.sourceContents);
                for (let n = 0, r = t.length; n < r; n++) e(o.fromSetString(t[n]), this.sourceContents[t[n]])
            }
            toString() {
                let e = "";
            ...
            toStringWithSourceMap(e) {
                ...
                return this.walk(function (e, r) {
                    t.code += e, null !== r.source && null !== r.line && null !== r.column ? (i === r.source && s === r.line && u === r.column && l === r.name || n.addMapping({
                        source: r.source,
                        original: {
                            line: r.line,
                            column: r.column
                        ...
                        name: r.name
                    }), i = r.source, s = r.line, u = r.column, l = r.name, o = !0) : o && (n.addMapping({
                        generated: {
                            line: t.line,
                            column: t.column
                        }
                    }), i = null, o = !1);
                    for (let s = 0, u = e.length; s < u; s++) e.charCodeAt(s) === a ? (t.line++, t.column = 0, s + 1 === u ? (i = null, o = !1) : o && n.addMapping({
                        source: r.source,
                        original: {
                            line: r.line,
                            column: r.column
