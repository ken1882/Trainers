...
parser.add_argument("-crs", "--check-resources", help="Check whether has enough resources for combat", action=Ptrue)
...
def load():  
  ...
  G.FlagCheckCombatResources = args.check_resources
