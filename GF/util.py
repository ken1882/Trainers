...
def getPixel(x=None, y=None):
  ...
  if x and y:
    try:
      ...
      print("Error: getPixel position out of range:", x, y)
      return (-0xfe, -0xfe, -0xfe)
  return ScreenSnapShot[1]

def flush_screen_cache():
  global LastFrameCount, ScreenSnapShot
  LastFrameCount = 0
  ScreenSnapShot[0] = 0
...
def align_window(wx=None,wy=None):
  ...
  if wy is None:
    wy = y
  win32gui.MoveWindow(G.AppHwnd, wx, wy, const.AppWidth, const.AppHeight, 1)
  uwait(1)
  getAppRect()
