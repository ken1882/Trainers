...
Enum = {
  ...
  'RefightComplete6': {
    'pos': ((291, 493),(382, 481),(462, 503),(598, 480),(657, 476),),
    'color': ((156, 158, 165),(165, 168, 173),(187, 161, 220),(66, 107, 169),(90, 146, 214),)
  },
  'RefightComplete7': {
    'pos': ((291, 491),(384, 482),(467, 502),(605, 482),(677, 480),),
    'color': ((148, 154, 156),(165, 166, 173),(186, 159, 218),(66, 105, 165),(90, 142, 209),)
  },
  'RefightComplete8': {
    'pos': ((240, 491),(322, 485),(518, 503),(653, 478),(749, 478),),
    'color': ((148, 146, 148),(165, 166, 173),(184, 159, 217),(57, 101, 156),(82, 134, 198),)
  },
  'RefightComplete9': {
    'pos': ((198, 492),(280, 483),(562, 502),(696, 480),(777, 475),),
    'color': ((156, 158, 156),(165, 166, 165),(188, 164, 221),(57, 101, 156),(82, 134, 198),)
  },
  'RefightComplete10': {
    'pos': ((293, 496),(377, 483),(462, 502),(604, 477),(686, 479),),
    'color': ((148, 154, 156),(165, 166, 165),(189, 160, 222),(57, 97, 148),(82, 134, 198),)
  },
  ...
  'Errand': {
    'pos': ((9, 52),(98, 28),(711, 28),(812, 33),(39, 321),),
    'color': ((33, 32, 49),(255, 255, 255),(231, 242, 255),(239, 247, 255),(49, 56, 82),(33, 36, 49),(41, 48, 66),)
  },
  'Errand2': {
    'pos': ((12, 51),(98, 28),(809, 30),(35, 116),),
    'color': ((33, 32, 49),(231, 243, 255),(33, 36, 49),(255, 255, 244),)
  },
  'Errand3': {
    'pos': ((40, 202),(42, 39),(703, 29),(794, 26),(122, 26),(31, 115),),
    'color': ((247, 255, 156),(33, 36, 57),(49, 56, 82),(33, 36, 49),(252, 255, 255),(140, 162, 181),)
  },
  'Errand4': {
    'pos': ((26, 200),(21, 37),(706, 26),(798, 27),(32, 115),),
    'color': ((247, 255, 187),(33, 32, 49),(49, 56, 82),(33, 36, 49),(140, 162, 181),)
  },
  'ConfirmFuelCost': {
    'pos': ((320, 410),(416, 402),(559, 411),(652, 397),),
    'color': ((148, 151, 156),(173, 170, 173),(74, 125, 189),(89, 138, 206),)
  },
  'NoEnhanceMats': {
  ...
  'Victory': {
    'pos': ((191, 191),(346, 218),(499, 168),(508, 251),(565, 234),(188, 230),),
    'color': ((247, 239, 133),(252, 207, 97),(223, 166, 91),(238, 242, 122),(234, 234, 92),(255, 255, 158),)
  },
  'Victory2': {
    'pos': ((212, 202),(222, 228),(267, 206),(343, 217),(422, 197),),
    'color': ((255, 255, 239),(255, 227, 107),(255, 231, 132),(250, 205, 96),(255, 255, 189),)
  }
}
